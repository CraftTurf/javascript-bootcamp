...
var flowNameRegex = /^flow-v[0-9]+.[0-9]+.[0-9]+$/;
/**
 ...
 * directory.
 */
function runTestGroup(repoDirPath, testGroup) {
  var _this5 = this;

  var numberOfFlowVersions = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 15;
  var errors = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [];
  var testDirName, testDirPath, orderedFlowVersions, destLibDefPath, copiedFileNames, testGrpFlowSemVerRange, flowVersionsToRun, lowestFlowVersionRan, lowerVersions, higherVersions, lowerVersionErrors, higherVersionErrors, lowestCapableFlowVersion;
  return regeneratorRuntime.async(function runTestGroup$(_context15) {
    while (1) {
      switch (_context15.prev = _context15.next) {
        ...
        case 17:
          orderedFlowVersions = _context15.sent;
          _context15.next = 25;
          break;
    ...
    while (1) {
      switch (_context16.prev = _context16.next) {
        ...
        case 14:
          ...
          _context16.next = 18;
          return regeneratorRuntime.awrap(runTestGroup(repoDirPath, testGroup, numberOfFlowVersions));
